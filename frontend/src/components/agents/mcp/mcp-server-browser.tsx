...
export const MCPServerBrowser: React.FC<MCPServerBrowserProps> = ({
  ...
  console.log('MCP Browser - Loading:', isLoading);
  console.log('MCP Browser - Servers count:', servers.length);
  console.log('MCP Browser - Popular servers:', popularServers);
  console.log('MCP Browser - All servers:', allServers);
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                console.log('Switching to popular tab');
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        {server.homepage && (
                          <a
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              console.log('Opening homepage:', server.homepage);
                            }}
                          >
